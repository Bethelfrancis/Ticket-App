...
function TicketForm({ initial, onSave, onCancel }) {
    const [data, setData] = useState(
        initial || { title: "", status: "open", description: "" }
    );
    ...
    function submit(e) {
        e.preventDefault();
        const errs = validateTicket(data);
        setErrors(errs);
...
export default function Tickets() {
    ...
    async function handleUpdate(data) {
        try {
            ...
            setToast("Failed to update ticket");
        }
    }
    async function handleDelete(id) {
        ...
        try {
            ...
            setToast("Failed to delete ticket");
        }
    }
  ...
  return (
    <div>
        ...
        {creating && (
            <TicketForm onSave={handleCreate} onCancel={() => setCreating(false)} />
        )}
        {editing && (
            <TicketForm
                initial={editing}
